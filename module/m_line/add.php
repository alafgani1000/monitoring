...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "validate-form")) {
  $insertSQL = sprintf("INSERT INTO m_line (id_line,nm_line,line,tgl_entry,user_posting) VALUES ( %s, %s, %s, %s, %s)",
    ...
    <form  action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" class="block-content form" >
      <div class="_50">
        <p>
          ...
          <input id="" name="nm_line" style="text-align:center" class="required" type="text" />
        </p>
      </div>
	  <div class="_50">
        <p>
          <label for="jobs">Line Produksi</label>
          <input id="" name="line" type="text" value="" class="required" />
        </p>
      </div>
     <div class="clear"></div>	       
      <div class="block-actions">
        <ul class="actions-left">
          <li><a class="button red"  href="?mod=m_line">Back</a>
