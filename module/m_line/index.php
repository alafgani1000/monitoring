...
<div class="grid_12"> 
   <br/>
   <a href='?mod=m_line&amp;act=add' class='button'>
   <span>Add Line</span>
   </a></div>
         ...
         <?php $no = 1;?>
          <?php do { ?>
            <tr class=gradeX>			
			  ...
			  <td>&nbsp; <?php echo $row_rs_line['line']; ?></td>
			  <td width="90"><center> <a href="?mod=m_line&amp;act=delete&id_line=<?php echo $row_rs_line['id_line']; ?>" onclick="return confirm('Hapus Data <?php echo $row_rs_line['line']; ?> ')">
				  <img src="img/icons/packs/silk/16x16/cross.png" width="16" height="16" alt="Hapus" title="Hapus" /></a> |
				  <a href="?mod=m_line&amp;act=edit&id_line=<?php echo $row_rs_line['id_line']; ?>"><img src="img/icons/packs/fugue/16x16/block--arrow.png" width="16" height="16" alt="Detail" title="Detail" /></a></center>
			  </td>
            </tr>
