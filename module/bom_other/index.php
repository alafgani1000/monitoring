...
$query_lvl = "SELECT DISTINCT a.ITEMNO,b.[DESC] AS kett,a.BOMNO,b.STOCKITEM,b.STOCKUNIT,b.AUDTDATE,b.AUDTUSER,b.CNTLACCT
				FROM ICBOMD a JOIN ICITEM b on b.ITEMNO=a.ITEMNO
				WHERE a.BOMNO in('R0') and b.INACTIVE IN('0') 
				AND a.BOMNO in('R0') and b.INACTIVE IN('0') 
				 and b.[DESC] NOT LIKE 'DU%' AND b.CNTLACCT LIKE '%FAPOTH%'";
         ...
         <?php $no = 1;?>
          <?php do { ?>
            <tr class=gradeX>			
			  ...
			  <td width="10%"><center>
				<a href="javascript:void(0);"	onclick="window.open('module/bom_other/pdf.php?ITEMNO=<?php echo $row_rs_lvl['ITEMNO']; ?>','nama_window_pop_up','size=800,height=800,scrollbars=yes,resizeable=no')">
				<img src="img/icons/packs/fugue/16x16/blue-document-pdf.png" width="16" height="16" alt="PDF" title="PDF" /></a>
				|<a href="javascript:void(0);"	onclick="window.open('module/bom_other/laporan.php?ITEMNO=<?php echo $row_rs_lvl['ITEMNO']; ?>','nama_window_pop_up','size=800,height=800,scrollbars=yes,resizeable=no')">
				<img src="img/icons/packs/fugue/16x16/document-excel-table.png" width="16" height="16" alt="DOWN" title="DOWN" />
				|<a href="?mod=bom_other&amp;act=detail&ITEMNO=<?php echo $row_rs_lvl['ITEMNO']; ?>"><img src="img/icons/packs/silk/16x16/magnifier_zoom_in.png" width="16" height="16" alt="Detail" title="Detail" /></a></center>
				</center>
			</td>
            </tr>
