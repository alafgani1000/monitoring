...
FROM [dbo].[ICITEM] a JOIN ICBOMD b ON b.COMPONENT=a.ITEMNO
 WHERE b.ITEMNO='$_GET[ITEMNO]' and b.BOMNO IN('R0') and a.INACTIVE IN ('0') order by b.[LINENO]";
	...
	$memek = "SELECT [dbo].ICIOTH.MANITEMNO, [dbo].ICIOTH.ITEMDESC, [dbo].ICIOTH.COMMENT, [dbo].ICIOTH.ITEMNO
					...
					<td width="96%" height="15" colspan="3" scope="col" align="left">Keterangan :<br>
						<table width="100%" border="0">	
							<?php $no = 1;?>
								<?php do { ?>
							<tr>
								<td height="13" align="left" colspan="1"><div valign="justify"><?php echo $ngentot['MANITEMNO']; ?></div></td>
								<td height="13" align="left" colspan="1"><div valign="justify"><?php echo $ngentot['ITEMDESC']; ?></div></td>
								<td height="13" align="left" colspan="8"><div valign="justify"><?php echo $ngentot['COMMENT']; ?></div></td>
							</tr>
