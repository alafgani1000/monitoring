...
<body>
	<form name="form" enctype="multipart/form-data" class="block-content form">
		<table width="100%" border="0" >
			...
			<tr>
				<td width="30%" colspan="3"><font size='2'>PT.YASUNAGA INDONESIA</font></td>
				<td>&nbsp;</td>
				<td width="70%" rowspan="10"><div align="center">
					<table width="100%" border="1" cellspacing="2" cellpadding="1">
						...
						<tr>
							...
							<td width="15%"><div align="center">Check</div></td>
							<td width="100%" colspan="4"><div align="center">Approval</div></td>
						</tr>
						<tr>
						...
						<tr>
							<td width="15%"><div align="center">Purniawan</div></td>
							<td width="15%"><div align="center">Habibi</div></td>
							<td width="15%"><div align="center">Risto J </div></td>
							<td width="15%"><div align="center">PPIC</div></td>
							<td width="15%"><div align="center">Prod</div></td>
							<td width="15%"><div align="center">Mr.Ando</div></td>
						</tr>
					</table></div>
				</td>
			</tr>
			<tr>
				<td colspan="3"><font size='2'>ENGINEERING AIR PUMP</font></td>
			...
			<tr>
				<td colspan="3"><font size='2'>Bill Of Material : <?php echo $row_rs_req['ITEMNO']; ?></font> </td>
				
			</tr>
			<tr>
				<td colspan="3" ><font size='2'><?php echo $row_rs_req['BOMNO']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;<?php echo $row_rs_req['kett']; ?></font></td>
